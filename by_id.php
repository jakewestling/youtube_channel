<div class="row bg-light-gray" id="by-id">
  ...
  <div id="content" class="mt-1">
    <div class="col-12 d-block text-center">
      ...
      <div class="modal fade" id="by-id-question" tabindex="-1" role="dialog" aria-labelledby="byIDModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="byIDModalLabel">What is a YouTube Channel ID?</h5>
            ...
            <div class="modal-body">
              ...
              Users:  Please use the <a href="" class="text-red" data-dismiss="modal" onclick="displaySearchChannels()"><i class="fas fa-search"></i> Channels</a> feature. You can find channel data by searching for the channel name instead.<br><br>
